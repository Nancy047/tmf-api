...
public class ApplicationController {
    ...
    public List<ApplicationApproval> findAllApplication() {
        return applicationService.getAllApplications();
    }

    @GetMapping("/getAllApplicationBasedFields")
    public List<ApplicationFieldSelection> findAllApplicationSelectionFields() {
        List<ApplicationApproval> application = applicationService.getAllApplications();
    ...
    public ApplicationResponse createApplication(@RequestBody ApplicationApproval application) {
        ApplicationApproval applicationResponse = applicationService.createApplication(application);
    ...
    public ApplicationResponse findApplicationById(@PathVariable(required = true) String id) {
        Optional<ApplicationApproval> application = applicationService.getApplicationById(id);
    ...
    public Optional<ApplicationApproval> findApplicationFieldsById(@PathVariable(required = true) String id) {
        return applicationService.getApplicationById(id);
    }

    @PatchMapping("/updateApplicationById/{id}")
    public ResponseEntity<ApplicationApproval> updateApplicationById(@PathVariable(required = true) String id, @RequestBody UpdateApplicationRequest updateApplicationRequest) {
        Optional<ApplicationApproval> updatedApp = applicationService.updateApplication(id, updateApplicationRequest);
